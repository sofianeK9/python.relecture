...
# réponse 3.9
weigth_alpha = 120 / 1000
print(weigth_alpha)

weigth_beta = 100 / 1000
print(weigth_beta)

price_per_kilos_alpha = 2 / weigth_alpha
print(price_per_kilos_alpha)

price_per_kilos_beta = 1.7/ weigth_beta
print(price_per_kilos_beta)

if price_per_kilos_alpha < price_per_kilos_beta:
    print(False)
else :
    print(False)